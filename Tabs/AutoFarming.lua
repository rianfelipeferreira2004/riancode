...
--==================================================
-- FEATURE 3: Auto Place Egg (entrega na base)
--==================================================
...
PlaceHolder.Parent = AutoFarmingPage
...
local function TogglePlace()
    PlaceEnabled = not PlaceEnabled
    PlaceCheck.Visible = PlaceEnabled
...
--==================================================
-- FEATURE 4: Auto Hatch (+ remote assist)
--==================================================
...
HatchHolder.LayoutOrder = 6
HatchHolder.Parent = AutoFarmingPage
...
local function ToggleHatch()
    HatchEnabled = not HatchEnabled
    HatchCheck.Visible = HatchEnabled
...
HatchRemoteButton.MouseButton1Click:Connect(function()
    HatchRemoteOn = not HatchRemoteOn
    if HatchRemoteOn then
